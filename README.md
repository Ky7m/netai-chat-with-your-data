...
- [Solution Overview](./docs/SolutionOverview.md)
  - [Upload Document](./docs/SolutionOverview.md#upload-document)
  - [Process an Uploaded Document](./docs/SolutionOverview.md#process-an-uploaded-document)
  - [Chat steps for each question](./docs/SolutionOverview.md#chat-steps-for-each-question)
- [Resources](#resources)
...
![Chat Application running](./images/10ChatApp.gif)
...
![Document Management Application running ](./images/14DocMngr.png)
...
1. Provision and deploy all the resources:
    ...
    It will prompt you to provide an `azd` environment name (like "**chat=with-your-data**"), select a subscription from your Azure account, and select a [location where Azure AI Search and the OpenAI models gpt-4o and ADA-002 are available](https://azure.microsoft.com/explore/global-infrastructure/products-by-region/?products=cognitive-services&regions=all) (like "eastus2").
...
- Azure OpenAI Service: S0 tier, gpt-4o and text-embedding-ada-002 models. Pricing is based on token count. [Pricing](https://azure.microsoft.com/pricing/details/cognitive-services/openai-service/)
...
- [eShopLite Semantic Search](https://aka.ms/netaieshoplitesemanticsearch) is a reference .NET application implementing an eCommerce site with Search features using Keyword Search and Semantic Search.

- [eShopLite Semantic Search Azure AI Search](https://aka.ms/netaieshoplitesemanticsearchazureaisearch) is a reference .NET application implementing an eCommerce site with Search features using Keyword Search and Semantic Search with Azure AI Search.
